    ...
    >
      <GestureHandlerRootView style={{ flex: 1 }}>
        <FlingGestureHandler
          ...
          onHandlerStateChange={goToCamera}
        >
          <View style={styles.wrapper}>
            <View style={styles.div}>
              ...
              Recycling is a small step with a big impact. Use this app to learn, engage, and make sustainable choices for a better future.
{'\n'}{'\n'}
Now, let’s find out what’s recyclable and start collecting! Are you ready?
              </Text>
            </View>
            <View
              style={{
